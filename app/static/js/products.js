...
function showToast(message) {
  ...
  toast.innerHTML = `
    ...
    <span>${message}</span>
    <a href="/" style="color:white; font-weight:700; margin-left:10px; text-decoration:underline;">Log in</a>
    <a href="/register" style="color:white; font-weight:700; margin-left:8px; text-decoration:underline;">Sign up</a>
  `;
  toast.style.cssText = `
    position: fixed;
    bottom: 28px;
